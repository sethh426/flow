...
const navItems = [
  { href: '/trends', label: 'AI Opportunity Finder', icon: TrendingUp },
  { href: '/project-hub', label: 'Projects', icon: Package },
  { href: '/products', label: 'Products', icon: LayoutGrid },
  { href: '/scheduler/calendar', label: 'Calendar', icon: Clock },
  ...
  { href: '/content-generator', label: 'AI Content Generator', icon: FileText },
