...
export function ProductEditForm({ product }: ProductEditFormProps) {
  ...
  // Database check removed - using API routes instead
  ...
  const handleGenerateAnalysis = async () => {
    ...
    try {
      ...
      // Call API to update product with analysis
            ...
            <CardFooter className="border-t pt-6 flex justify-between gap-3">
              ...
              <div className="flex items-center gap-3">
                 <Button
                    ...
                    onClick={() => {
                        if (!product.id) {
                            toast({ variant: "destructive", title: 'Cannot Schedule', description: 'Product must be saved before scheduling.'});
                            return;
                        }
